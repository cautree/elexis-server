...
public class TarmedOptifier implements IOptifier<TarmedLeistung> {
	 ...
	 * Behandlung nach Entfernung dieses Codes noch konsistent verrechnet wäre und
	 * ggf. anpassen oder das Entfernen verweigern. Diese Version macht keine
	 * Prüfungen, sondern erfüllt nur die Anfrage..
	 */
	public Result<Verrechnet> remove(Verrechnet code, Behandlung kons) {
		...
		if (left.isEmpty()) {
			List<Verrechnet> verrechnetWithBezug = getVerrechnetWithBezugMatchingCode(kons.getLeistungen(),
